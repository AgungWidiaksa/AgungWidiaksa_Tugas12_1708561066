...
<html>
	...
	<body>
		<div class="log">
			...
			<div style="margin-top: 3%; background-color: #4183D7; color: white; text-align: center; padding: 15px;">mahasiswa -> email = widiaksa@gmail.com, password = user || admin -> email = admin@gmail.com, password = admin</div>
		</div>
	</body>
</html>