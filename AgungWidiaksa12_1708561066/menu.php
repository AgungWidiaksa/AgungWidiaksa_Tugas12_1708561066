<?php
session_start();
 $conn = mysqli_connect("localhost","root","","praksession12") or die(mysqli_error());
    if($_SESSION['status'] === "login"){
        $nama = $_SESSION['nama'];
        $level = $_SESSION['jenis'];
    }
    else {
...
<body <?php echo ($_SESSION['jenis']!='Admin') ? "style='background-color: #e8f0fe'" : "style='background-color: #aeff90'"; ?>>
    <div id="head">
        <div id="gambarutama">
        ...
        <div id="content2">
            <h1 class="h1content2">Selamat Datang <span <?php echo ($_SESSION['jenis']!='Admin') ? "style='color: #4183D7'" : "style='color: #008000'"; ?> ><?= $_SESSION['nama'] ?></span> di Website Universitas Udayana</h1><br>
            <span class="sub-title"> (anda login sebagai : <b><?= $_SESSION['jenis'] ?></b>)</span>
